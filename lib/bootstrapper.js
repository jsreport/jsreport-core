...
Bootstrapper.prototype.start = function () {
  ...
  return q().then(function () {
    ...
    self.config.connectionString = self.config.connectionString || {name: 'memory'}
...
Bootstrapper.prototype._createLogger = function () {
  ...
  return this['_createLogger' + this.config.logger.providerName]()
}
...
module.exports = function (options) {
  ...
  options.extensionsManager = options.extensionsManager || {supportsUnregistration: true}
