...
ExtensionsManager.prototype._saveDiscoveredExtensionsToCache = function () {
  if (this.reporter.options.mode !== 'production' || this.reporter.options.extensionsLocationCache === false) {
    return q()
  }
...
ExtensionsManager.prototype._getExtensionDirectories = function (pathToSearch) {
  ...
  if (this.reporter.options.mode !== 'production' || this.reporter.options.extensionsLocationCache === false) {
    self.reporter.logger.info('Skipping extensions location cache in non production environment or when option extensionsLocationCache === false, crawling now')
