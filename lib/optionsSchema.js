...
const { getDefaultTaskStrategy, getDefaultTempDirectory, getDefaultLoadConfig } = require('./defaults')
  ...
  properties: {
    ...
    templatingEngines: {
      ...
      properties: {
        strategy: {
          type: 'string',
          enum: ['in-process', 'dedicated-process', 'http-server', 'worker-threads'],
          default: getDefaultTaskStrategy()
        },
