 ...
 */
  async init () {
    ...
    if (this.compilation2) {
      this.compilation2.resource('sandbox.js', require.resolve('vm2/lib/sandbox.js'))
      this.compilation2.resource('contextify.js', require.resolve('vm2/lib/contextify.js'))
    }
