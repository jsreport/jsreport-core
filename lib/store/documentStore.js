...
const DocumentStore = (options, validator, encryption) => {
   ...
   */
    ...
    updateReference (collectionReferenceOriginName, entity, collectionReferenceTargetName, referenceValue, newReferenceValue) {
      return updateReferenceValue(this, collectionReferenceOriginName, entity, collectionReferenceTargetName, referenceValue, newReferenceValue)
    },
